...
echo '<table border="0" cellspacing="2" cellpadding="2"> 
      <tr> 
          <th> <font face="Arial">Candidate Name</font> </th> 
          ...
          <th> <font face="Arial">Gender</font> </th>
			...
			<th> <font face="Arial">Phone_no</font> </th>
...
if ($result = $mysqli->query($query)) {
    while ($row = $result->fetch_assoc()) {
        $field1name = $row["candidate_name"];
        $field2name = $row["dob"];
        $field3name = $row["age"];
        $field4name = $row["gender"];
		$field5name = $row["university"];
		$field6name = $row["experience"];
		$field7name = $row["email"];
		$field8name = $row["phone_number"];
		$field9name = $row["skills"];
