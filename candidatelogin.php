...
<div class="w3-top">
  <div class="w3-bar w3-theme w3-top w3-left-align w3-large">
	...
	<a href="formshow.php" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Companies</a>
...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row w3-padding-64">
    <div class="w3-twothird w3-container">
	  ...
	  <p>1.Please do checkout the jobs vacant and fill your details in the following link</p>
	  <p><a href="candidateform.html">click here</a></p>
	  
      <p>2. You can find the links for Companies registered, jobs vacant and interview approval in the menu bar above.</P>
