...
<div class="w3-top">
  <div class="w3-bar w3-theme w3-top w3-left-align w3-large">
	...
	<a href="jobform.html" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Jobs_details</a>
...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row w3-padding-64">
    <div class="w3-twothird w3-container">
	  ...
	  <p><a href="companyform.html">click here</a></p>
	  <p>2. You can post the jobs vacant at your place and view the same in the tabular form. Links are available in the menu bar.</p>
